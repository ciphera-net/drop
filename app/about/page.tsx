  ...
  return (
    <div className="container mx-auto max-w-3xl px-6 pt-12">
      <div className="prose prose-neutral max-w-none">
        <h1 className="text-4xl font-bold tracking-tight text-neutral-900 mb-8">Why We Built Drop</h1>
        
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 mb-4">Why don't most web services end-to-end encrypt your data?</h2>
          ...
          <div className="bg-orange-50 border-l-4 border-brand-orange p-4 my-6 rounded-r-lg">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 mb-4">The importance of end-to-end encryption</h2>
          <p className="text-lg text-neutral-600 mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 mb-4">Simple, fast, and private</h2>
          <p className="text-lg text-neutral-600 mb-4">
