  ...
  return (
    <div className="container mx-auto max-w-3xl px-6 pt-12">
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h1 className="text-4xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100 mb-8">Security Design</h1>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 dark:text-neutral-200 mb-4">End-to-End Encryption</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 dark:text-neutral-200 mb-4">Key Management</h2>
          <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-4">
          ...
          <div className="bg-neutral-100 dark:bg-neutral-800 p-4 rounded-md font-mono text-sm text-neutral-800 dark:text-neutral-200 mb-4 overflow-x-auto">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 dark:text-neutral-200 mb-4">Web Crypto API</h2>
          <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 dark:text-neutral-200 mb-4">Transport Layer Security (TLS)</h2>
          <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-4">
