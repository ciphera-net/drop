  ...
  return (
    <div className="container mx-auto max-w-3xl px-6 pt-12">
      <div className="prose prose-neutral max-w-none">
        <h1 className="text-4xl font-bold tracking-tight text-neutral-900 mb-8">Frequently Asked Questions</h1>
        
        <div className="space-y-12">
          <section>
            <h3 className="text-xl font-bold text-neutral-900 mb-3">Is Drop secure?</h3>
          ...
          <section>
            <h3 className="text-xl font-bold text-neutral-900 mb-3">How long are files stored?</h3>
            <p className="text-lg text-neutral-600">
          ...
          <section>
            <h3 className="text-xl font-bold text-neutral-900 mb-3">What is the maximum file size?</h3>
            <p className="text-lg text-neutral-600">
          ...
          <section>
            <h3 className="text-xl font-bold text-neutral-900 mb-3">Do I need an account?</h3>
            <p className="text-lg text-neutral-600">
          ...
          <section>
            <h3 className="text-xl font-bold text-neutral-900 mb-3">Is there a mobile app?</h3>
            <p className="text-lg text-neutral-600">
