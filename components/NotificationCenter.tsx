...
/**
 * Notification center: bell icon with dropdown of recent notifications.
 */
...
export default function NotificationCenter() {
  ...
  const SkeletonCircle = ({ className }: { className?: string }) => (
    <div className={`rounded-full bg-neutral-200 dark:bg-neutral-800 animate-pulse ${className}`} />
  )
  const SkeletonLine = ({ className }: { className?: string }) => (
    <div className={`rounded bg-neutral-200 dark:bg-neutral-800 animate-pulse ${className}`} />
  )
